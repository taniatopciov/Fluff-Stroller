...
public class AvailableWalksAdapter extends RecyclerView.Adapter<AvailableWalksAdapter.ViewHolder> {
    ...
    public AvailableWalksAdapter(FeesService feesService, List<DogWalk> availableWalks,
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.priceTextView.setText(String.format("%.2f", feesService.getDogWalkPriceWithoutFees(dogWalk.getTotalPrice())) + " RON");

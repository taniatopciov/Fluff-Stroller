package com.example.fluffstroller.ui.home;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        binding.registerButtonTemp.setOnClickListener(view -> Navigation.findNavController(view).navigate(R.id.nav_register));
